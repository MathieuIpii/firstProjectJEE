...
public class ProductController implements Serializable {
    ...
    //D'abord :
        ...
        Product product3 = new Product(1, 50, 9.99f, "Dinette", "une petite dinette tranquille", "webapp/resources/img/dinette.jpg");
        Product product4 = new Product(2, 10, 49.99f, "Grande lampe", "une belle lampe de salon posée", "webapp/resources/img/lampe-salon.jpg");
        Product product5 = new Product(2, 20, 24.99f, "Petite lampe de chevet", "une petite lampe de chevet posée", "webapp/resources/img/lampe.jpg");
        Product product6 = new Product(2, 50, 14.99f, "Spot de soirée", "pour faire une grosse fête ou juste une soirée posée", "webapp/resources/img/spot.jpg");
